...
def part1_1():
	mat = scipy.io.loadmat(str(os.getcwd()) +  "/ex4data1.mat" )
	X, y = mat['X'], mat['y']
	displayData( X )
...
def part1_2():
	...
	# Load the weights
	mat = scipy.io.loadmat( str(os.getcwd()) +  "/ex4weights.mat" )
...
def part2_3():
	...
	J, theta = nnCostFunction( unraveled, input_layer_size, hidden_layer_size, num_labels, X, y, lamda )
	print (J)
	print (theta)
...
if __name__ == '__main__':
	...
	"""
		MAtlab style functions shorthand in python :
			In matlab, one can make a file called funct.m:
